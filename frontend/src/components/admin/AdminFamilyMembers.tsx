  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h2 className="text-2xl font-bold text-black">Family Members</h2>
          <p className="text-gray-600 text-sm mt-1">Manage your family tree</p>
        </div>
        <button
          onClick={() => {
            setEditingMember(null);
          ...
          <Card key={member._id}>
            <div className="flex items-start justify-between gap-4">
              <div className="flex-1 min-w-0">
                <h3 className="text-lg font-bold text-black mb-2 truncate">{member.name}</h3>
                <div className="space-y-1">
                  <p className="text-sm text-gray-600">ID: {member.id}</p>
                  <p className="text-sm text-gray-600">Generation: {member.generation}</p>
                </div>
              </div>
      ...
      >
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label className="block text-sm font-medium text-black mb-1">Avatar URL</label>
            <input
              type="url"
